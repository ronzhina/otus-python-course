...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        passwords = ['JnecJnec', 'JnecJnec', 'JnecJnec', 'JnecJnec']

        params = zip(usernames, passwords, names, surnames, patronymics, departments, positions)
        for username, password, name, surname, patronymic, department, position in params:
            Employee.objects.get_or_create(username=username,
                                           password=password,
                                           name=name,
                                           surname=surname,
