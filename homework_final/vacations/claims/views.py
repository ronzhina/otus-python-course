...
class ClaimApproveDetailView(LoginRequiredMixin, PageNameMixin, DetailView):
    model = Claim
    page_name = 'Заявление'
    template_name = 'claims/claim_approve_detail.html'
...
class ClaimCreateView(LoginRequiredMixin, PageNameMixin, CreateView):
    ...
    def get_form_kwargs(self):
        kwargs = super(ClaimCreateView, self).get_form_kwargs()
